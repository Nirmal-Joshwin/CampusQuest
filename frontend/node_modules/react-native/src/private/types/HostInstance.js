 ...
 * @see https://github.com/facebook/react-native/blob/master/Libraries/Renderer/shims/ReactNativeTypes.js_L87
 */
export interface LegacyHostInstanceMethods {
   ...
   * prop](docs/view.html_onlayout) instead.
   */
  ...
  /**
   * Like [`measure()`](_measure), but measures the view relative an ancestor,
