 ...
 * See https://dom.spec.whatwg.org/_interface-eventtarget.
 */
...
export default class EventTarget {
   ...
   * (see https://dom.spec.whatwg.org/_get-the-parent).
   */
 ...
 * (see https://dom.spec.whatwg.org/_concept-event-dispatch).
 */
 ...
 * (see https://dom.spec.whatwg.org/_event-path).
 *
 ...
 * (see https://dom.spec.whatwg.org/_concept-event-listener-invoke).
 */
function invoke(
  eventTarget: EventTarget,
  event: Event,
